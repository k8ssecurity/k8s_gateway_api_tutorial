...
### Viewing runtime logs for MCP interactions (Playwright or other clients)

When troubleshooting Playwright MCP interactions or other client activity, you can view the runtime logs captured at `/home/runner/work/_temp/runtime-logs/fw.jsonl`:
...
This displays all captured runtime events with timestamps and details for debugging network, firewall, or gateway issues.
